...
public class ManageOutCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_out_category);
            ...
            switch (v.getId()){
                ...
                case R.id.btn_confirm1:
                    ...
                    if (TextUtils.isEmpty(category)){
                        Toast.makeText(ManageOutCategoryActivity.this,"未输入分类名",Toast.LENGTH_SHORT).show();
                    }
                    else if (Bookkeeping_setting.Add_Category(ManageOutCategoryActivity.this,username,0,category) == 0){
                        Toast.makeText(ManageOutCategoryActivity.this,"添加成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                    break;
                case R.id.btn_confirm2:
                    ...
                    if (TextUtils.isEmpty(subcategory)){
                        ...
                        Toast.makeText(ManageOutCategoryActivity.this,"未选择分类",Toast.LENGTH_SHORT).show();
                    }
                    else if (Bookkeeping_setting.Add_expense_Subcategory(ManageOutCategoryActivity.this,username,add_subcategory,subcategory) == 0){
                        Toast.makeText(ManageOutCategoryActivity.this,"添加成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                ...
                case R.id.btn_confirm3:
                    if (delete_category < 1){
                        Toast.makeText(ManageOutCategoryActivity.this,"未选择分类",Toast.LENGTH_SHORT).show();
                    }else if (Bookkeeping_setting.Delete_expense_Category(ManageOutCategoryActivity.this,username,delete_category) == 0){
                        Toast.makeText(ManageOutCategoryActivity.this,"删除成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                    break;
                case R.id.btn_confirm4:
                    ...
                    else if (Bookkeeping_setting.Delete_Expense_Subcategory(ManageOutCategoryActivity.this,username,delete_subcategory,delete_select_category) == 0){
                        Toast.makeText(ManageOutCategoryActivity.this,"删除成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                ...
                case R.id.btn_confirm5:
                    ...
                    if (TextUtils.isEmpty(edit_category)){
                        ...
                        int i = Bookkeeping_setting.Change_Expense_Category(ManageOutCategoryActivity.this,username,edit_category_num,0,edit_category);
                        Toast.makeText(ManageOutCategoryActivity.this,"修改成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                    break;
                case R.id.btn_confirm6:
                    ...
                    else if (Bookkeeping_setting.Change_expense_Subcategory(ManageOutCategoryActivity.this,username,edit_subcategory_num,edit_select_category_num,edit_subcategory) == 0){
                        Toast.makeText(ManageOutCategoryActivity.this,"修改成功",Toast.LENGTH_SHORT).show();
                        LoadData();
                        finish();
                    }
                ...
                case R.id.btn_select_category:
                    pvOptions = new OptionsPickerBuilder(ManageOutCategoryActivity.this, new OnOptionsSelectListener() {
                        @Override
                        public boolean onOptionsSelect(View view, int options1, int options2, int options3) {
                            ...
                            Toast.makeText(ManageOutCategoryActivity.this,"选中了:"+st,Toast.LENGTH_SHORT).show();
                            return false;
                        }
                    })
                            .build();
                ...
                case R.id.btn_delete_category:
                    pvOptions2 = new OptionsPickerBuilder(ManageOutCategoryActivity.this, new OnOptionsSelectListener() {
                        @Override
                        public boolean onOptionsSelect(View view, int options1, int options2, int options3) {
                            String st = options1Items.get(options1).name;
                ...
                case R.id.btn_delete_subcategory:
                    pvOptions3 = new OptionsPickerBuilder(ManageOutCategoryActivity.this, new OnOptionsSelectListener() {
                        @Override
                        public boolean onOptionsSelect(View view, int options1, int options2, int options3) {
                            String st;
                ...
                case R.id.btn_select_category_edit:
                    pvOptions4 = new OptionsPickerBuilder(ManageOutCategoryActivity.this, new OnOptionsSelectListener() {
                        @Override
                        public boolean onOptionsSelect(View view, int options1, int options2, int options3) {
                            String st = options1Items.get(options1).name;
                ...
                case R.id.btn_select_subcategory_edit:
                    pvOptions5 = new OptionsPickerBuilder(ManageOutCategoryActivity.this, new OnOptionsSelectListener() {
                        @Override
                        public boolean onOptionsSelect(View view, int options1, int options2, int options3) {
                            String st;
    ...
    private void LoadData(){
        message = Return_message.Return(ManageOutCategoryActivity.this,0,username);
